pkg_name=jenkins-subversion
pkg_origin=qago
pkg_version="2.9"
pkg_description="Jenkins subversion plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins subversion@2.9
}
