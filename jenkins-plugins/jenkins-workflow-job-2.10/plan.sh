pkg_name=jenkins-workflow-job
pkg_origin=qago
pkg_version="2.10"
pkg_description="Jenkins workflow-job plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-job@2.10
}
