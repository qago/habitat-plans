pkg_name=jenkins-built-on-column
pkg_origin=qago
pkg_version="1.1"
pkg_description="Jenkins built-on-column plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins built-on-column@1.1
}
