pkg_name=jenkins-hidden-parameter
pkg_origin=qago
pkg_version="0.0.4"
pkg_description="Jenkins hidden-parameter plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins hidden-parameter@0.0.4
}
