pkg_name=jenkins-xunit
pkg_origin=qago
pkg_version="1.102"
pkg_description="Jenkins xunit plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins xunit@1.102
}
