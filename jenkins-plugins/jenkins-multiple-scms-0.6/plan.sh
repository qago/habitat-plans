pkg_name=jenkins-multiple-scms
pkg_origin=qago
pkg_version="0.6"
pkg_description="Jenkins multiple-scms plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins multiple-scms@0.6
}
