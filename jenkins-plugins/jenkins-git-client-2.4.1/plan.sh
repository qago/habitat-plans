pkg_name=jenkins-git-client
pkg_origin=qago
pkg_version="2.4.1"
pkg_description="Jenkins git-client plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins git-client@2.4.1
}
