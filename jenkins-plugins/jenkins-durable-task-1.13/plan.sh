pkg_name=jenkins-durable-task
pkg_origin=qago
pkg_version="1.13"
pkg_description="Jenkins durable-task plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins durable-task@1.13
}
