pkg_name=jenkins-token-macro
pkg_origin=qago
pkg_version="2.0"
pkg_description="Jenkins token-macro plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins token-macro@2.0
}
