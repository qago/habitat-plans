pkg_name=jenkins-workflow-basic-steps
pkg_origin=qago
pkg_version="2.4"
pkg_description="Jenkins workflow-basic-steps plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-basic-steps@2.4
}
