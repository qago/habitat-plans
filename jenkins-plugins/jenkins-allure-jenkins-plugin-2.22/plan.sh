pkg_name=jenkins-allure-jenkins-plugin
pkg_origin=qago
pkg_version="2.22"
pkg_description="Jenkins allure-jenkins-plugin plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins allure-jenkins-plugin@2.22
}
