pkg_name=jenkins-junit
pkg_origin=qago
pkg_version="1.20"
pkg_description="Jenkins junit plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins junit@1.20
}
