pkg_name=jenkins-pipeline-stage-step
pkg_origin=qago
pkg_version="2.2"
pkg_description="Jenkins pipeline-stage-step plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-stage-step@2.2
}
