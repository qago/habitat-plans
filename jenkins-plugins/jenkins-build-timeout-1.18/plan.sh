pkg_name=jenkins-build-timeout
pkg_origin=qago
pkg_version="1.18"
pkg_description="Jenkins build-timeout plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins build-timeout@1.18
}
