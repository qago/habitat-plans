pkg_name=jenkins-rebuild
pkg_origin=qago
pkg_version="1.25"
pkg_description="Jenkins rebuild plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins rebuild@1.25
}
