pkg_name=jenkins-ace-editor
pkg_origin=qago
pkg_version="1.1"
pkg_description="Jenkins ace-editor plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins ace-editor@1.1
}
