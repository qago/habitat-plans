pkg_name=jenkins-matrix-project
pkg_origin=qago
pkg_version="1.9"
pkg_description="Jenkins matrix-project plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins matrix-project@1.9
}
