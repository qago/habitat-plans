pkg_name=jenkins-docker-workflow
pkg_origin=qago
pkg_version="1.10"
pkg_description="Jenkins docker-workflow plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins docker-workflow@1.10
}
