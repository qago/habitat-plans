pkg_name=jenkins-parameterized-trigger
pkg_origin=qago
pkg_version="2.33"
pkg_description="Jenkins parameterized-trigger plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins parameterized-trigger@2.33
}
