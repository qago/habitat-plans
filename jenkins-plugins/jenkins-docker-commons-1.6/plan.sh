pkg_name=jenkins-docker-commons
pkg_origin=qago
pkg_version="1.6"
pkg_description="Jenkins docker-commons plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins docker-commons@1.6
}
