pkg_name=jenkins-cloudbees-folder
pkg_origin=qago
pkg_version="6.0.3"
pkg_description="Jenkins cloudbees-folder plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins cloudbees-folder@6.0.3
}
