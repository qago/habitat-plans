pkg_name=jenkins-pipeline-milestone-step
pkg_origin=qago
pkg_version="1.3.1"
pkg_description="Jenkins pipeline-milestone-step plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-milestone-step@1.3.1
}
