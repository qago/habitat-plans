pkg_name=jenkins-workflow-cps
pkg_origin=qago
pkg_version="2.29"
pkg_description="Jenkins workflow-cps plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-cps@2.29
}
