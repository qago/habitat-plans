pkg_name=jenkins-pipeline-graph-analysis
pkg_origin=qago
pkg_version="1.3"
pkg_description="Jenkins pipeline-graph-analysis plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-graph-analysis@1.3
}
