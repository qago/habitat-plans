pkg_name=jenkins-pipeline-stage-view
pkg_origin=qago
pkg_version="2.6"
pkg_description="Jenkins pipeline-stage-view plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-stage-view@2.6
}
