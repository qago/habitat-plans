pkg_name=jenkins-run-condition
pkg_origin=qago
pkg_version="1.0"
pkg_description="Jenkins run-condition plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins run-condition@1.0
}
