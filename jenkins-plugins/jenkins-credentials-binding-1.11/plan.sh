pkg_name=jenkins-credentials-binding
pkg_origin=qago
pkg_version="1.11"
pkg_description="Jenkins credentials-binding plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins credentials-binding@1.11
}
