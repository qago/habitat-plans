pkg_name=jenkins-workflow-step-api
pkg_origin=qago
pkg_version="2.9"
pkg_description="Jenkins workflow-step-api plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-step-api@2.9
}
