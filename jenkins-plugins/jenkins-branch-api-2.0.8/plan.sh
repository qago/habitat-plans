pkg_name=jenkins-branch-api
pkg_origin=qago
pkg_version="2.0.8"
pkg_description="Jenkins branch-api plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins branch-api@2.0.8
}
