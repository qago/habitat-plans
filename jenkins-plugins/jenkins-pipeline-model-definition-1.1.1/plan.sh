pkg_name=jenkins-pipeline-model-definition
pkg_origin=qago
pkg_version="1.1.1"
pkg_description="Jenkins pipeline-model-definition plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-model-definition@1.1.1
}
