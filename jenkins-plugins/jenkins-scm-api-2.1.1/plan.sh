pkg_name=jenkins-scm-api
pkg_origin=qago
pkg_version="2.1.1"
pkg_description="Jenkins scm-api plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins scm-api@2.1.1
}
