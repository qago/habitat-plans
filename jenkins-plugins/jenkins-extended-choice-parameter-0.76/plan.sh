pkg_name=jenkins-extended-choice-parameter
pkg_origin=qago
pkg_version="0.76"
pkg_description="Jenkins extended-choice-parameter plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins extended-choice-parameter@0.76
}
