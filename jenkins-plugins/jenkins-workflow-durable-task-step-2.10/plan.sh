pkg_name=jenkins-workflow-durable-task-step
pkg_origin=qago
pkg_version="2.10"
pkg_description="Jenkins workflow-durable-task-step plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-durable-task-step@2.10
}
