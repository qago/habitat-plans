pkg_name=jenkins-envinject
pkg_origin=qago
pkg_version="1.93.1"
pkg_description="Jenkins envinject plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins envinject@1.93.1
}
