pkg_name=jenkins-git-server
pkg_origin=qago
pkg_version="1.7"
pkg_description="Jenkins git-server plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins git-server@1.7
}
