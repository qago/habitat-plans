pkg_name=jenkins-pipeline-model-extensions
pkg_origin=qago
pkg_version="1.1.1"
pkg_description="Jenkins pipeline-model-extensions plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-model-extensions@1.1.1
}
