pkg_name=jenkins-workflow-scm-step
pkg_origin=qago
pkg_version="2.4"
pkg_description="Jenkins workflow-scm-step plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-scm-step@2.4
}
