pkg_name=jenkins-htmlpublisher
pkg_origin=qago
pkg_version="1.12"
pkg_description="Jenkins htmlpublisher plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins htmlpublisher@1.12
}
