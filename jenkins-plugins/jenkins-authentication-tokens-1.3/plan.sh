pkg_name=jenkins-authentication-tokens
pkg_origin=qago
pkg_version="1.3"
pkg_description="Jenkins authentication-tokens plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins authentication-tokens@1.3
}
