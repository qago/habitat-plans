pkg_name=jenkins-icon-shim
pkg_origin=qago
pkg_version="2.0.3"
pkg_description="Jenkins icon-shim plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins icon-shim@2.0.3
}
