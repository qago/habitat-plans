pkg_name=jenkins-structs
pkg_origin=qago
pkg_version="1.6"
pkg_description="Jenkins structs plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins structs@1.6
}
