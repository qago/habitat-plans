pkg_name=jenkins-validating-string-parameter
pkg_origin=qago
pkg_version="2.3"
pkg_description="Jenkins validating-string-parameter plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins validating-string-parameter@2.3
}
