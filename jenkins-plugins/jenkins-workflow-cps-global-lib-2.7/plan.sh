pkg_name=jenkins-workflow-cps-global-lib
pkg_origin=qago
pkg_version="2.7"
pkg_description="Jenkins workflow-cps-global-lib plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-cps-global-lib@2.7
}
