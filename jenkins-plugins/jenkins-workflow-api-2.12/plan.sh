pkg_name=jenkins-workflow-api
pkg_origin=qago
pkg_version="2.12"
pkg_description="Jenkins workflow-api plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-api@2.12
}
