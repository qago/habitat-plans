pkg_name=jenkins-pipeline-build-step
pkg_origin=qago
pkg_version="2.4"
pkg_description="Jenkins pipeline-build-step plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-build-step@2.4
}
