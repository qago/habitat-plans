pkg_name=jenkins-script-security
pkg_origin=qago
pkg_version="1.27"
pkg_description="Jenkins script-security plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins script-security@1.27
}
