pkg_name=jenkins-handlebars
pkg_origin=qago
pkg_version="1.1.1"
pkg_description="Jenkins handlebars plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins handlebars@1.1.1
}
