pkg_name=jenkins-workflow-multibranch
pkg_origin=qago
pkg_version="2.14"
pkg_description="Jenkins workflow-multibranch plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-multibranch@2.14
}
