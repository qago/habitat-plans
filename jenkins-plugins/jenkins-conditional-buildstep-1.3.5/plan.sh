pkg_name=jenkins-conditional-buildstep
pkg_origin=qago
pkg_version="1.3.5"
pkg_description="Jenkins conditional-buildstep plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins conditional-buildstep@1.3.5
}
