pkg_name=jenkins-pipeline-stage-tags-metadata
pkg_origin=qago
pkg_version="1.1.1"
pkg_description="Jenkins pipeline-stage-tags-metadata plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-stage-tags-metadata@1.1.1
}
