pkg_name=jenkins-workflow-support
pkg_origin=qago
pkg_version="2.14"
pkg_description="Jenkins workflow-support plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-support@2.14
}
