pkg_name=jenkins-workflow-aggregator
pkg_origin=qago
pkg_version="2.5"
pkg_description="Jenkins workflow-aggregator plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins workflow-aggregator@2.5
}
