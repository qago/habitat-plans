pkg_name=jenkins-javadoc
pkg_origin=qago
pkg_version="1.4"
pkg_description="Jenkins javadoc plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins javadoc@1.4
}
