pkg_name=jenkins-pipeline-input-step
pkg_origin=qago
pkg_version="2.5"
pkg_description="Jenkins pipeline-input-step plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins pipeline-input-step@2.5
}
