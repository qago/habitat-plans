pkg_name=jenkins-mapdb-api
pkg_origin=qago
pkg_version="1.0.9.0"
pkg_description="Jenkins mapdb-api plugin"
...
do_download() {
    ...
    bash $PLAN_CONTEXT/install_jenkins_plugin.sh -d $HAB_CACHE_SRC_PATH/$pkg_dirname/plugins mapdb-api@1.0.9.0
}
